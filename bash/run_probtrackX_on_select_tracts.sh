...
i=0
LINE_COUNT=0
SOURCE=("PostTemp_top_90" "AntTemp_top_90" "MFG_top_90")
TARGETS=("IFG_top_90" "IFGorb_top_90")
...
printf "%s,%s,%s,%s,%s,%s\n" "row" "subject_name" "segment_name" "source_name" "target_name" "hemi"   >> $SUBJECT_PROBX_FILE
